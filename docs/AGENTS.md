...
**Primary reference optimized for AI models and coding assistants working on the family-oriented educational platform.**
...
- **Complete Setup**: [`setup.md`](./setup.md) - Environment configuration and troubleshooting
- **Project Tracking**: [`tasks.md`](./tasks.md) - Development roadmap and progress
- **Business Logic**: [`subscription-tier-analysis.md`](./subscription-tier-analysis.md) - Subscription feature analysis
- **Navigation Hub**: [`README.md`](./README.md) - Documentation overview and quick start

---

**🤖 For AI/Agent Use**: This document contains 95% of critical system knowledge needed for effective development assistance. Refer to other docs only for specific setup issues or business requirements. 